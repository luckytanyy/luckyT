...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='work_dirs/pretrain/unireplknet_l_in22k_to_in1k_384_acc87.88.pth'),
        # init_cfg=dict(type='Pretrained', checkpoint='work_dirs/pretrain/unireplknet_b_in22k_to_in1k_384_acc87.40.pth'),
    ),
    neck=dict(
        type='CAFPN',
