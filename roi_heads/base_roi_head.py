# from jdet.utils.registry import  MODELS, BOXES, HEADS, LOSSES, ROI_EXTRACTORS
from mmengine import build_from_cfg
from mmengine.registry import MODELS
from mmdet.models.utils import multi_apply
from mmrotate.models.utils.bbox_transforms import bbox2roi, dbbox2roi
from mmrotate.models.utils.nms_rotated import ml_nms_rotated
from mmrotate.models.task_modules.coders.box_ops import rotated_box_to_poly
...
class BaseRoIHead(nn.Module):
    def __init__(self,
        ...
        self.loss_cls = build_from_cfg(loss_cls, weighted_loss) if loss_cls is not None else None
        self.loss_bbox = build_from_cfg(loss_bbox, weighted_loss) if loss_bbox is not None else None
        self.cfg = cfg
